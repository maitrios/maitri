...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "maitri-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("maitri polkit agent registered")
      else console.warn("maitri polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "maitri-polkit"
