...
Item {
  ...
  // Injected by maitri-shell; defaults to the session MAITRI_PATH.
  property string maitriPath: Quickshell.env("MAITRI_PATH")
  property string stateHome: Quickshell.env("HOME") + "/.local/state"
  property string imageDirs: Quickshell.env("MAITRI_IMAGE_SELECTOR_DIRS") || Quickshell.env("MAITRI_IMAGE_SELECTOR_DIR") || Quickshell.env("MAITRI_STOCK_BACKGROUNDS_DIR") || (stateHome + "/maitri/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("MAITRI_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("MAITRI_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("MAITRI_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return maitriPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by maitri-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "maitri-image-selector"
