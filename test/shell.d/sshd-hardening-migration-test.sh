...
run_migration() {
  ...
  local config="$root/etc/ssh/sshd_config.d/10-maitri-hardening.conf"
  ...
  sed "s|^config=/etc/ssh/sshd_config.d/10-maitri-hardening.conf$|config=$config|" "$migration" |
...
[[ ! -e $test_dir/disabled/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
grep -qxF "PasswordAuthentication no" "$test_dir/hardened/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf" ||
...
[[ ! -e $test_dir/no-key/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
[[ ! -e $test_dir/private-key/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
grep -qxF "PasswordAuthentication no" "$test_dir/symlink-key/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf" ||
...
if (( EUID != 0 )); then
  ...
  [[ ! -e $test_dir/unreadable/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
[[ ! -e $test_dir/loose-home/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
config="$test_dir/active/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf"
...
[[ -e $test_dir/stopped/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
[[ ! -e $test_dir/invalid-config/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
[[ -e $test_dir/reload-fail/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
...
[[ ! -e $test_dir/no-sudo/root/etc/ssh/sshd_config.d/10-maitri-hardening.conf ]] ||
