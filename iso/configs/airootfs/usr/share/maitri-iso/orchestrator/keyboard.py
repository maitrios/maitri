...
produces the part of that output maitri actually consumes — KEYMAP for the
console plus the XKB* settings in vconsole.conf that maitri's
...
generated: nothing on an maitri system reads it.
"""
