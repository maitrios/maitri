o.bind("SUPER + SPACE", "Launcher", "maitri-launch-vicinae")
o.bind("SUPER + ALT + SPACE", "maitri menu", "maitri-menu toggle root")
o.bind("SUPER + CTRL + E", "Emojis", "maitri-menu-emoji")
...
o.bind("SUPER + K", "Keybindings", "maitri-launch-vicinae vicinae://launch/@kindness-ai/maitri/keybindings")
...
o.bind("SUPER + CTRL + SPACE", "Background switcher", "maitri-launch-vicinae vicinae://launch/@kindness-ai/maitri/background-picker")
o.bind("SUPER + SHIFT + CTRL + SPACE", "Theme menu", "maitri-launch-vicinae vicinae://launch/@kindness-ai/maitri/theme-picker")
