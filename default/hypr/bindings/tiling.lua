...
o.bind("CTRL + ALT + DELETE", "Close all windows", "maitri-hyprland-window-close-all")

o.bind("SUPER + J", "Toggle window split", hl.dsp.layout("togglesplit"))
o.bind("SUPER + P", "Pseudo window", hl.dsp.window.pseudo())
o.bind("SUPER + T", "Toggle window floating/tiling", hl.dsp.window.float({ action = "toggle" }))
o.bind("SUPER + F", "Full screen", hl.dsp.window.fullscreen({ mode = "fullscreen" }))
o.bind("SUPER + CTRL + F", "Tiled full screen", "maitri-hyprland-window-tiled-fullscreen-toggle")
o.bind("SUPER + ALT + F", "Full width", hl.dsp.window.fullscreen({ mode = "maximized" }))
o.bind("SUPER + O", "Pop window out (float & pin)", "maitri-hyprland-window-pop")
o.bind("SUPER + ALT + Home", "Save window width", "maitri-hyprland-window-width save")
o.bind("SUPER + Home", "Restore window width", "maitri-hyprland-window-width restore")
o.bind("SUPER + L", "Toggle workspace layout", "maitri-hyprland-workspace-layout-toggle")
