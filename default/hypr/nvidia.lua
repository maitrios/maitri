...
local nvidia = paths.maitri_path .. "/bin/maitri-hw-nvidia"
local nvidia_gsp = paths.maitri_path .. "/bin/maitri-hw-nvidia-gsp"
local nvidia_without_gsp = paths.maitri_path .. "/bin/maitri-hw-nvidia-without-gsp"
