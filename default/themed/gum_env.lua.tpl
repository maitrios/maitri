...
hl.env("GUM_INPUT_PLACEHOLDER_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_FILTER_PLACEHOLDER_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_FILTER_UNSELECTED_PREFIX_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_FILE_PERMISSIONS_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_FILE_FILE_SIZE_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_PAGER_LINE_NUMBER_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_PAGER_HELP_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_WRITE_CURSOR_LINE_NUMBER_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_WRITE_LINE_NUMBER_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_WRITE_PLACEHOLDER_FOREGROUND", "{{ dark_foreground }}")
...
hl.env("GUM_LOG_TIME_FOREGROUND", "{{ dark_foreground }}")
